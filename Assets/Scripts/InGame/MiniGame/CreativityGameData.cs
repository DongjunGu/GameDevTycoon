...
public static class CreativityGameData
{
    ...
    static CreativityGameData()
    {
        ...
        var cOrange = new Color(1f, 0.6f, 0.15f);  // V3 전용 주황(개별 지정)
        ...
        var bV2 = B("V2", c3, (0,0),(1,0));   // 개별 지정: 3칸 초록

        // ── 3칸 (초록) ──────────────────────────────────────────────────────
        // X X       X X       X .       . X       X       X X X
        // X .       . X       X X       X X       X
        //                                         X
        var bG_TR = B("G_TR", c2, (0,0),(0,1),(1,0));   // 개별 지정: 2칸 노랑
        var bG_TL = B("G_TL", c3, (0,0),(0,1),(1,1));
        var bG_BR = B("G_BR", c3, (0,0),(1,0),(1,1));
        var bG_BL = B("G_BL", c3, (0,1),(1,0),(1,1));
        var bV3   = B("V3",   cOrange, (0,0),(1,0),(2,0));   // 개별 지정: 주황
