...
public static class RandomEvents_Dev
{
    public static void Register(List<RandomEventData> pool, RandomEventManager mgr)
    {
        pool.Add(new RandomEventData
        {
            ...
            triggerChance = mgr.blackoutChance,
            onApply       = () =>
            {
        ...
        pool.Add(new RandomEventData
        {
            ...
            triggerChance = mgr.teamDinnerChance,
            onApply       = () =>
            {
        ...
        pool.Add(new RandomEventData
        {
            ...
            triggerChance = mgr.eventDetailTriggerChance,
        ...
        pool.Add(new RandomEventData
        {
            ...
            title         = "네트워크 장애!",
            description   = "직원이 커피를 쏟아\n네트워크가 박살났습니다!\n개발 속도가 일시적으로 감소합니다.",
            triggerChance = mgr.eventDetailTriggerChance,
            onApply       = () => mgr.ApplyNetworkIssue()
        });
